...
CREATE TABLE crime(id serial NOT NULL,data date,hora time,id_vitima serial,id_rua serial,id_bairro serial,id_cidade serial, id_tipo_crime serial,PRIMARY KEY(id),
