...
def insere_tabela(lst_linhas):
	...
	for linha in lst_linhas:
		...
		sql = "INSERT INTO crime(numero,data,hora,tipo_crime,sexo,idade,cidade,bairro,rua) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s)"
		sql_data = (numero,data,hora,tipo_crime,sexo,idade,cidade,bairro,rua)
